...
<main>
    <div class="bg-white mx-auto max-w-7xl py-6 sm:px-6 lg:px-8 mt-10">
        <form method="POST" action="/note">
            ...
            <div class="mt-6 flex items-center justify-end gap-x-4">
                <a href="/notes" class="rounded-md bg-gray-500 px-3 py-2 text-sm font-semibold text-white shadow-sm
